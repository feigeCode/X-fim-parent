package com.feige.fim.constant;
...
public interface ServerConfigKey {
    ...
    String SERVER_TCP_K_C_P = "fim.server.tcp.ssl.key-cert-chain-path";
    String SERVER_TCP_P_K_P = "fim.server.tcp.ssl.private-key-path";
    String SERVER_TCP_K_P = "fim.server.tcp.ssl.key-password";
    String SERVER_TCP_T_C_P = "fim.server.tcp.ssl.trust-cert-collection-path";
    ...
    String SERVER_WS_K_C_P = "fim.server.ws.ssl.key-cert-chain-path";
    String SERVER_WS_P_K_P = "fim.server.ws.ssl.private-key-path";
    String SERVER_WS_K_P = "fim.server.ws.ssl.key-password";
    String SERVER_WS_T_C_P = "fim.server.ws.ssl.trust-cert-collection-path";
