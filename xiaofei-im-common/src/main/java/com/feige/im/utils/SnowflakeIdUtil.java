...
public class SnowflakeIdUtil {
    private static final SnowflakeIdUtil idWorker;
    private static String HOST_NAME_HOLDER;
    ...
    public static String getHostName() {
        ...
        try {
            ...
            if(HOST_NAME_HOLDER ==null){
                ...
                HOST_NAME_HOLDER = localHost.getHostName();
            }
        } catch (IOException e) {
        }
        return HOST_NAME_HOLDER;
